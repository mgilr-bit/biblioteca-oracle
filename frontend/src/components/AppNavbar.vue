  ...
  <header class="app-nav">
    <div class="container app-nav__inner">
      ...
      <nav class="app-nav__links">
        ...
        <router-link v-can:read="'Multa'" to="/multas" class="app-nav__link" active-class="is-active">
          Multas
        </router-link>
        ...
        <router-link v-can:read="'Analitica'" to="/analitica" class="app-nav__link" active-class="is-active">
          Analítica
        </router-link>
      </nav>
